// ======================================================================
// Read_Acc_Data_XYZ.v generated from TopDesign.cysch
<<<<<<< HEAD
// 07/17/2024 at 17:25
=======
// 07/17/2024 at 17:56
...
module top ;
	...
	cy_clock_v1_0
		#(.id("93679bc7-9519-4c51-94ff-939056e1fe6e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2dfc5242-da00-4e59-bf65-1895bbbd9075"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("91f2a5d0-1506-4264-af73-7b101797b00f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f8d06310-4633-4885-abf9-370af964cff3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
