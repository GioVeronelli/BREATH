...
int main(void)
{
    ...
    //SET DEL CONTROL_REGISTER_1: ENABLE XYZ AXIS AND ODR:200HZ
    uint8_t ctrl_reg1;
    ...
    if(ctrl_reg1 != LIS3DH_NORMAL_MODE_CTRL_REG1_200_XYZ)
    {
        ctrl_reg1 = LIS3DH_NORMAL_MODE_CTRL_REG1_200_XYZ;
